  ...
  Gi = ({ dynamicBroMissions: t, onUpdateMissions: m }) => {
    ...
    return D
      ...
      : x.isBro
        ...
        .ritual-glow {
          position: absolute; width: 100%; height: 100%;
          background: radial-gradient(circle, rgba(139, 0, 255, 0.5) 0%, transparent 75%);
...
`);
        ...
        .badge-glow-effect {
          ...
          inset: -5px;
          border-radius: 50%;
          background: radial-gradient(circle, rgba(255, 140, 0, 0.7) 0%, rgba(255, 69, 0, 0.2) 50%, transparent 70%);
          filter: blur(8px);
          opacity: 0;
          transition: all 0.3s ease;
          transform: scale(0.8);
        ...
        .profile-badge-row-trigger:hover .badge-glow-effect {
          opacity: 1;
          transform: scale(1.1);
          filter: blur(10px);
        }
        .profile-badge-row-trigger:hover .badge-icon-wrapper {
          transform: scale(1.05);
          filter: drop-shadow(0 0 10px rgba(255, 140, 0, 0.6));
        }
        .collection-badge-glow {
        ...
        .collection-badge-card:hover .collection-badge-glow {
          opacity: 1;
          transform: scale(1.2);
          filter: blur(14px);
        }
        .collection-badge-card:hover .collection-badge-icon {
