...
def get_store(name: str):
    ...
    if store is None:
        raise KeyError(
            ...
            f"bro_events, bro_passports, bro_submissions, bro_initiatives, shift_schedule, workshops, parent_suggestions, users, workshop_proposals, role_requests, family_links, engine_join_requests, engine_projects, engine_initiatives"
        )
    return store
