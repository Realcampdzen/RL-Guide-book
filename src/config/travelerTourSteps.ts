...
export function getTravelerTourSteps(controller: AppController): HintStep[] {
  return [
    ...
    },
    {
      ...
      content: 'Здесь родители следят за достижениями участников. Вообще, платформа поддерживает множество ролей: Участник, Родитель, Вожатый, Педагог/Тренер, Старший Вожатый и Начальник Лагеря!',
