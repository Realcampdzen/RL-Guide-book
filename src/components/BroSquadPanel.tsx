    ...
    >
      ...
      <div className="fade-in" style={glassCard}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 14 }}>
          ...
          <div>
            <div
              style={{ fontSize: 18, fontWeight: 800, color: '#e0d4ff', letterSpacing: '-0.02em' }}
            >
              Броотряд
            </div>
            <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.4)', marginTop: 2 }}>
              Сообщество прошедших Бросвящение · {total} участник
              {total === 1 ? '' : total < 5 ? 'а' : 'ов'}
            </div>
          </div>
        </div>
        <p style={{ margin: 0, fontSize: 13, color: 'rgba(255,255,255,0.5)', lineHeight: 1.5 }}>
          Здесь собраны все, кто прошёл Бросвящение — независимо от отрядов и ролей. Один БРО-отряд
          на весь лагерь.
        </p>
      </div>
      ...
      {loading && (
        <div
          style={{ fontSize: 12, color: 'rgba(255,255,255,0.4)', textAlign: 'center', padding: 20 }}
        >
          Загрузка…
        </div>
      )}
              ...
              >
                <div
                  style={{
                    ...
                    borderRadius: 10,
                    background:
                      'linear-gradient(135deg, rgba(124,58,237,0.2), rgba(139,0,255,0.1))',
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                    fontSize: 16,
                    ...
                    {m.avatar && isImageAvatar(m.avatar) ? (
                      <img
                        ...
                        onError={(e) => {
                          ...
                          e.currentTarget.parentElement!.innerText = m.nickname
