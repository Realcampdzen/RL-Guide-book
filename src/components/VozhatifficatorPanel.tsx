      ...
      {tab === 'main' && (
        ...
        >
          ...
          <div style={{ fontSize: 11, opacity: 0.7, marginTop: 4 }}>
            {lightsDone}/{lightsTotal} Путеводных Огней зажжено
          </div>
        </div>
      )}
            ...
            <div style={{ height: 6, borderRadius: 3, background: 'rgba(0,0,0,0.3)' }}>
              <div
                style={{
                  ...
                  height: '100%',
                  borderRadius: 3,
                  background: lightsPct === 100 ? '#22c55e' : ACCENT,
                  transition: 'width 0.3s',
                }}
              />
            </div>
            ...
            return (
              <div
                ...
                style={{
                  ...
                  padding: '6px 8px',
                  borderRadius: 8,
                  background: done ? 'rgba(34,197,94,0.08)' : 'rgba(0,0,0,0.12)',
                  opacity: done ? 0.7 : 1,
                }}
              >
      ...
      {(tab === '2019-2022' || tab === '2023+') && (
        ...
        >
          ...
          <div style={{ fontSize: 11, opacity: 0.6 }}>
            Раздел в разработке. Будет доступен в следующих обновлениях.
          </div>
          <div
            style={{
              marginTop: 8,
