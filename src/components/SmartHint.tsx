...
export const SmartHint: React.FC<SmartHintProps> = ({
  ...
  let modalBottom: string | undefined;
    ...
    >
      ...
      <div
        style={{
          ...
          boxShadow:
            '0 24px 48px rgba(0,0,0,0.6), 0 0 60px rgba(147, 51, 234, 0.3), inset 0 0 20px rgba(147, 51, 234, 0.1)',
          pointerEvents: 'auto',
          animation: targetRect
            ? 'slideUp 0.5s cubic-bezier(0.16, 1, 0.3, 1)'
            : 'popIn 0.5s cubic-bezier(0.16, 1, 0.3, 1)',
          color: '#fff',
      ...
      >
        ...
        <div
          style={{
            display: 'flex',
            gap: '12px',
            justifyContent: targetRect ? 'flex-start' : 'center',
          }}
        >
