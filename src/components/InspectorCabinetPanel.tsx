    ...
    loadMyBadgeRequests(accessToken)
      .then((reqs) => {
        const inspectorReqs = reqs.filter((r) => {
          ...
          return (
            ev?.source === 'inspector' || inspectorMissions.some((m) => m.badgeId === r.levelId)
          );
        });
      ...
      <div style={{ maxWidth: 680, margin: '0 auto', width: '100%' }}>
        <div className="fade-in cab-card" style={{ textAlign: 'center', padding: '32px 24px' }}>
          ...
          <p style={{ fontSize: '14px', opacity: 0.7, margin: '0 0 20px', lineHeight: 1.6 }}>
            7 дней · 7 миссий · 7 суперспособностей
            <br />
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
        ...
        <div className="fade-in cab-card">
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div>
              <div style={{ fontSize: '18px', fontWeight: 800, letterSpacing: 0.3 }}>
                Кабинет Инспектора
              </div>
              <div style={{ fontSize: '13px', opacity: 0.6, marginTop: '4px' }}>👤 {nickname}</div>
            </div>
            <div style={{ textAlign: 'right' }}>
              <div
                style={{
                  fontSize: '24px',
                  fontWeight: 800,
                  color: missionsAchieved >= 7 ? '#22c55e' : 'var(--violet-600)',
                }}
              >
                {missionsAchieved}/7
              </div>
              ...
              style={{
                ...
                background:
                  missionsAchieved >= 7
                    ...
                    : 'linear-gradient(90deg, var(--violet-600), #6366f1)',
          ...
          {isChiefUnlocked && (
            ...
            >
              ...
              <span
                style={{ fontSize: '13px', fontWeight: 700, color: '#ffd700', marginLeft: '8px' }}
              >
                Главный Инспектор разблокирован!
              </span>
            </div>
          )}
        </div>
        ...
        <div className="fade-in cab-card">
          ...
          >
            ...
            >
              <div style={{ fontSize: '22px', fontWeight: 800, color: 'var(--violet-600)' }}>
                {missionsAchieved}
              </div>
              <div style={{ fontSize: '11px', opacity: 0.5, marginTop: '2px' }}>
                Миссий пройдено
                        ...
                        <div style={{ fontSize: '11px', opacity: 0.5 }}>
                          {r.status === 'pending'
                            ...
                            : r.status === 'approved'
                              ...
                              : '❌ Отклонено'}
                          {ev?.durationMs
                            ? ` · ⏱ ${Math.floor(Number(ev.durationMs) / 60000)} мин`
                            : ''}
                        </div>
                      </div>
                      {r.resolutionNote && (
