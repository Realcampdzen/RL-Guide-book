...
export const InspectorBenefitPanel: React.FC<InspectorBenefitPanelProps> = ({
  ...
  const handleMarkDone = useCallback(
    async (taskId: string, checklistId: string) => {
  ...
  if (checklists.length === 0) {
    return (
      <div style={{ padding: 12, fontSize: 12, opacity: 0.6 }}>Нет чек-листов Инспектора.</div>
    );
  }
                ...
                >
                  <div
                    style={{
                      ...
                      height: '100%',
                      borderRadius: 3,
                      background: stats.complete ? '#22c55e' : '#3b82f6',
                    ...
                    return (
                      ...
                      >
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          {task.description && (
                            <div style={{ fontSize: 10, opacity: 0.6 }}>{task.description}</div>
                          )}
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            <div style={{ fontSize: 12, fontWeight: 700, color: '#22c55e' }}>
              Чек-лист «{completedChecklist}» завершён!
            </div>
