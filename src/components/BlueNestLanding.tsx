      ...
      <main>
        ...
        <section className="manifesto">
          <div className="manifesto-statement reveal-on-scroll">
            <h2>Значки здесь — <span style={{ whiteSpace: 'nowrap', hyphens: 'none', WebkitHyphens: 'none' }}>не награды,</span> а <span style={{ hyphens: 'none', WebkitHyphens: 'none' }}>маршруты</span> развития.</h2>
            <p>
