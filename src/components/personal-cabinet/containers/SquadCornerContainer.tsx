        ...
        <div style={{ width: '100%', paddingBottom: squadCornerTab === 'chat' ? 0 : 100 }}>
            {currentRole !== 'traveler' && squadCornerTab === 'squad' ? (
                ...
                (() => {
                    ...
                    return <SquadChat key="chat-active" squadId={sid} accessToken={accessToken || ''} nickname={nickname} deviceId={deviceId} role={currentRole || undefined} members={squadChatMembers} height="calc(100vh - 126px)" minHeight={0} />;
                })()
