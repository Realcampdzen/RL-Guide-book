...
export const useCabinetRouter = () => {
    ...
    const [counselorSquadTab, setCounselorSquadTab] = useState<'shift' | 'progress' | 'chat'>('progress');
    ...
    const [profile4KTab, setProfile4KTab] = useState<'progress' | 'arts' | 'squad' | 'tasks'>('progress');
    ...
    return {
        ...
        wsProposalType, setWsProposalType,
        activeTabId, setActiveTabId,
        squadCornerTab, setSquadCornerTab,
        counselorSquadTab, setCounselorSquadTab,
        adminPanelTab, setAdminPanelTab,
        realDiaryTab, setRealDiaryTab,
        profile4KTab, setProfile4KTab,
