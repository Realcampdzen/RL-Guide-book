    ...
    <div className="proof-modal-overlay" onClick={onClose}>
      ...
      >
        ...
        <p style={{ fontSize: 13, opacity: 0.9, marginBottom: 12 }}>
          Опишите желательные направления или значки для ребёнка — вожатый или организатор учтёт это при поддержке.
        </p>
        <textarea 
          value={value} 
          ...
          rows={4} 
          style={{ width: '100%', padding: 12, borderRadius: 8, border: '1px solid rgba(255,255,255,0.25)', background: 'rgba(0,0,0,0.2)', color: '#fff', fontSize: 14, resize: 'vertical', marginBottom: 12 }} 
        />
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
          ...
          <button 
            type="button" 
            onClick={onClose} 
            style={{ padding: '8px 16px', background: 'none', border: '1px solid rgba(255,255,255,0.3)', color: 'white', borderRadius: 8, cursor: 'pointer', fontSize: 13 }}
          >
            Отмена
          </button>
        </div>
