...
export const BroDelaPanel: React.FC = () => {
  ...
  const votesFor = (ini: BroInitiative) =>
    Object.values(ini.votes || {}).filter((v) => v === true).length;
  const votesAgainst = (ini: BroInitiative) =>
  ...
  const selectedTemplate = state.templateId
    ? BRODELA_TEMPLATES.find((t) => t.id === state.templateId)
    : null;
    ...
    <>
      <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
        <button
          ...
          onClick={() => {
            setShowTip(true);
            setTipIndex(Math.floor(Math.random() * BRODELA_TIPS.length));
          }}
      ...
      {showTip && (
        ...
        >
          ...
          <div style={{ marginTop: 6, display: 'flex', gap: 8 }}>
            <button
              type="button"
              onClick={() => setTipIndex(Math.floor(Math.random() * BRODELA_TIPS.length))}
              className="cab-btn-glass"
  ...
  return (
    ...
    >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <div className="cab-card">
            ...
            >
              <div>
                <div
                  style={{ fontSize: 16, fontWeight: 800, color: '#e0d4ff', letterSpacing: 0.5 }}
                >
                  КОНСТРУКТОР БРОДЕЛ
                </div>
                <div
                ...
                >
                  Собери отрядное дело из шаблонов или с нуля
                </div>
              ...
              {[1, 2, 3].map((s) => (
                <button
                  ...
                  style={{
                    ...
                    fontSize: 13,
                    fontWeight: 700,
                    cursor: s <= cStep || s === 1 ? 'pointer' : 'default',
                    fontFamily: 'inherit',
                    transition: 'all 0.2s',
                  }}
                >
          ...
          {cStep === 1 && (
            <div className="cab-card">
              ...
              <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap', marginBottom: 14 }}>
                ...
                {(
                  Object.entries(BRODELA_CATEGORY_META) as [
                    BroDelaCategory,
                  ...
                  <button
                    ...
                    style={{
                      ...
                      borderColor:
                        categoryFilter === key ? `${meta.color}66` : 'rgba(255,255,255,0.1)',
              ...
              >
                ...
                >
                  ...
                  <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.45)', lineHeight: 1.4 }}>
                    Создать пустое Бродело без шаблона
                  </div>
                </button>
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        <span
                          style={{ fontSize: 10, color: 'rgba(255,255,255,0.4)', fontWeight: 500 }}
                        >
                          {t.duration}
                        </span>
                      </div>
                      <div
                        style={{ fontSize: 13, fontWeight: 700, color: '#e0d4ff', lineHeight: 1.3 }}
                      >
                        {t.name}
                      </div>
                      <div
                      ...
                      <div style={{ fontSize: 10, color: catMeta.color, fontWeight: 600 }}>
                        {catMeta.label}
                      </div>
                    </button>
                  );
          ...
          {cStep === 2 && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                    ...
                    {['15 мин', '30 мин', '1 час', '2-3 часа', 'весь день'].map((d) => (
                      <button
                        ...
                        style={{
                          ...
                          background:
                            state.duration === d ? 'rgba(124,58,237,0.2)' : 'rgba(124,58,237,0.06)',
                          ...
                          <div style={{ display: 'flex', gap: 4 }}>
                            <button
                              ...
                              style={{
                                ...
                                color:
                                  idx === 0 ? 'rgba(255,255,255,0.15)' : 'rgba(255,255,255,0.5)',
                                fontSize: 11,
                            ...
                            <button
                              ...
                              style={{
                                ...
                                fontSize: 11,
                                cursor: idx === state.steps.length - 1 ? 'default' : 'pointer',
                                fontFamily: 'inherit',
                                display: 'flex',
                                alignItems: 'center',
                                justifyContent: 'center',
              ...
              >
                <button type="button" onClick={() => setCStep(1)} className="cab-btn-glass">
                  Назад
                </button>
                <button
                  type="button"
          ...
          {cStep === 3 && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              <div className="cab-card">
                ...
                >
                  <div style={{ fontSize: 16, fontWeight: 800, color: '#e0d4ff', marginBottom: 6 }}>
                    {state.name}
                  </div>
                  {state.description && (
                    <div
                  ...
                  {state.materials && (
                    <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.5)', marginBottom: 10 }}>
                      <span style={{ fontWeight: 700, color: '#c4b5fd' }}>Материалы: </span>
                      {state.materials}
                    </div>
                  )}
                  ...
                  {state.steps.length > 0 && (
                    <div>
                      <div
                        style={{ fontSize: 12, fontWeight: 700, color: '#c4b5fd', marginBottom: 8 }}
                      >
                      ...
                      {state.steps.map((s, i) => (
                        ...
                        >
                          <div style={{ fontSize: 12, fontWeight: 700, color: '#e0d4ff' }}>
                            {i + 1}. {s.title}
                          </div>
                          {s.description && (
                            <div
              ...
              <div
                style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}
              >
                <button type="button" onClick={() => setCStep(2)} className="cab-btn-glass">
                  Назад
                </button>
                <button
                  type="button"
        ...
        >
          ...
          >
            ...
            <div style={{ display: 'flex', gap: 10, justifyContent: 'flex-end' }}>
              <button type="button" onClick={() => setShowConfirm(false)} className="cab-btn-glass">
                Отмена
              </button>
              <button
                type="button"
      ...
      <div className="fade-in cab-card">
        ...
        >
          Бродела — инициативы БРО-сообщества для Совета лагеря. Создай через конструктор, собери
          голоса — и отправь в Совет!
        </p>
            ...
            {items.map((ini) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <div style={{ fontWeight: 700, fontSize: 14, color: '#e0d4ff' }}>
                      {ini.title}
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 6, flexShrink: 0 }}>
                      ...
                      {isMine && (
                        <button
                          type="button"
                          onClick={() => {
                            if (confirm('Удалить это Бродело?')) void deleteIni(ini.id);
                          }}
                          title="Удалить"
                          style={{
                            padding: '2px 6px',
                  ...
                  >
                    ...
                    <span style={{ fontSize: 10, color: 'rgba(255,255,255,0.3)' }}>
                      {new Date(ini.createdAt).toLocaleDateString('ru-RU')}
                    </span>
                  </div>
                  {/* Progress bar */}
                  <div
                  ...
                  <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', alignItems: 'center' }}>
                    {ini.status === 'voting' && mv === null && (
                      <>
                        ...
                        <button
                          type="button"
                          onClick={() => void vote(ini.id, false)}
                          style={{
                            padding: '6px 14px',
                            borderRadius: 10,
                    ...
                    {ini.status === 'approved' && (
                      <button
                        type="button"
                        onClick={() => void sendToCouncil(ini.id)}
                        className="cab-btn-accent"
                        style={{ padding: '6px 14px', fontSize: 12 }}
                      >
                        Отправить в Совет
