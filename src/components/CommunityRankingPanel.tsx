...
export const CommunityRankingPanel: React.FC<CommunityRankingPanelProps> = ({
  ...
  const categories = useMemo(() => {
    ...
    allBadges.forEach((b) => {
      if (b.category_id) set.add(b.category_id);
    });
      ...
      >
        ...
        {topWeekly.length === 0 ? (
          <div style={{ fontSize: 12, opacity: 0.7 }}>
            Пока нет лайков. Оцени значки в списке ниже!
          </div>
        ) : (
        ...
        <div style={{ display: 'grid', gap: 6 }}>
          {filteredBadges.map((badge) => {
            ...
            return (
              ...
              >
                <span
                  style={{ fontSize: 18, cursor: onNavigateToBadge ? 'pointer' : undefined }}
                ...
                >
                  ...
                  <div style={{ fontSize: 10, opacity: 0.6 }}>
                    Кат. {badge.category_id} · {badge.level}
                  </div>
                </div>
                <button
                  type="button"
      ...
      {creatorPopup && (
        ...
        >
          ...
          >
            ...
            <h4 style={{ margin: '0 0 4px', color: ACCENT, fontSize: 16 }}>
              {creatorPopup.nickname}
            </h4>
