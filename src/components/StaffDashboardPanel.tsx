    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
        <div style={{ ...CARD_STYLE, background: 'rgba(245,158,11,0.12)' }}>
          <div style={{ fontSize: 28, fontWeight: 800, color: '#f59e0b', lineHeight: 1.1 }}>
            {pendingRequests}
          </div>
        ...
        <div style={{ ...CARD_STYLE, background: 'rgba(52,211,153,0.12)' }}>
          <div style={{ fontSize: 28, fontWeight: 800, color: '#34d399', lineHeight: 1.1 }}>
            {approvedToday}
          </div>
      ...
      >
        ...
        {squadMembers.length === 0 ? (
          <div style={{ fontSize: 12, opacity: 0.6 }}>
            Нет участников. Привяжите отряд через код приглашения.
          </div>
        ) : (
          <div
            style={{
