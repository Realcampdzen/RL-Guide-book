...
const ChatBot: React.FC<ChatBotProps> = ({
  ...
  const containerStyle: React.CSSProperties = {
    ...
    height: isMobile && !isKeyboardOpen ? `calc(100svh - ${mobileNavHeightPx + 24}px)` : `${effectiveHeight}px`,
    maxHeight: isMobile && !isKeyboardOpen ? `calc(100svh - ${mobileNavHeightPx + 24}px)` : `${effectiveHeight}px`,
    display: 'flex',
