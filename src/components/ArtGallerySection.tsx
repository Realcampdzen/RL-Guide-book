...
import { type ArtItem, fetchArts, submitArt } from '../utils/badgeArtApi';
...
export const ArtGallerySection: React.FC<ArtGallerySectionProps> = ({ badgeId, accessToken }) => {
      ...
      {showSubmitModal && (
        ...
        >
          ...
          >
            ...
            {submitError && (
              <div style={{ fontSize: 12, color: '#ff6b6b', marginBottom: 8 }}>{submitError}</div>
            )}
