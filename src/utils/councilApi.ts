...
export async function fetchInitiatives(
  ...
  const data = await requestJson<{ initiatives: CouncilInitiativeItem[] }>(
    `/api/council/initiatives${suffix}`,
    {
...
export async function updateInitiativeStatus(
  ...
  return requestJson<{ initiative: CouncilInitiativeItem }>(
    `/api/council/initiatives/${encodeURIComponent(id)}`,
    {
      method: 'PATCH',
      headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${accessToken}` },
...
export async function voteInitiative(
  ...
  return requestJson<{
    ...
    voted: boolean;
    direction: string;
  }>(`/api/council/initiatives/${encodeURIComponent(id)}/vote`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${accessToken}` },
...
export async function getInitiativeComments(
  ...
  return requestJson<{ comments: InitiativeComment[] }>(
    `/api/council/initiatives/${encodeURIComponent(id)}/comments`,
    {
      headers: { Authorization: `Bearer ${accessToken}` },
    }
  );
...
export async function postInitiativeComment(
  ...
  return requestJson<{ comment: InitiativeComment; comments: InitiativeComment[] }>(
    `/api/council/initiatives/${encodeURIComponent(id)}/comments`,
    {
      method: 'POST',
      headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${accessToken}` },
...
export async function fetchProtocols(accessToken: string): Promise<CouncilProtocol[]> {
...
export async function fetchMembers(accessToken: string): Promise<CouncilMember[]> {
