...
const ShareContainer = withSuspense(
  React.lazy(() =>
    import('../components/profile/containers/ShareContainer').then((m) => ({ default: m.ShareContainer }))
  )
);

const JoinRequestsContainer = withSuspense(
  React.lazy(() =>
    import('../components/profile/containers/JoinRequestsContainer').then((m) => ({ default: m.JoinRequestsContainer }))
  )
);
              ...
              (travelerMode ? (
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                  <JoinRequestsContainer
                    ...
                    canModerateApprovals={canModerateApprovals}
                    canSeeOwnRequests={canSeeOwnRequests}
                    isParentChildReadonlyView={Boolean(isParentChildReadonlyView)}
                    syncApprovedLevels={syncApprovedLevels}
                    approvalsSyncBusy={approvalsSyncBusy}
                    approvalsSyncStatus={approvalsSyncStatus}
                    showSandbox={showSandbox}
                    isSpaceshipMode={isSpaceshipMode}
                    setActiveTab={setActiveTab}
                    setSquadCornerReturnToOrganizer={setSquadCornerReturnToOrganizer}
                    openCabinPanel={openCabinPanel}
                    badgeRequestsMine={badgeRequestsMine}
                    squadJoinRequestsMine={squadJoinRequestsMine}
                    badgeRequestsInbox={badgeRequestsInbox}
                    badgeRequestsBusy={badgeRequestsBusy}
                    badgeRequestsError={badgeRequestsError}
                    squadJoinRequestsBusy={squadJoinRequestsBusy}
                    squadJoinRequestsError={squadJoinRequestsError}
                    mySquadBusy={mySquadBusy}
                    mySquadError={mySquadError}
                    mySquadInfo={mySquadInfo}
                    loadBadgeApprovalsData={loadBadgeApprovalsData}
                    loadMySquadJoinRequestsData={loadMySquadJoinRequestsData}
                    loadMySquadInfo={loadMySquadInfo}
                    mySquadJoinCode={mySquadJoinCode}
                    setMySquadJoinCode={setMySquadJoinCode}
                    mySquadJoinId={mySquadJoinId}
                    setMySquadJoinId={setMySquadJoinId}
                    mySquadJoinBusy={mySquadJoinBusy}
                    mySquadJoinStatus={mySquadJoinStatus}
                    joinMySquadByCode={joinMySquadByCode}
                    joinMySquadById={joinMySquadById}
                    setMySquadJoinStatus={setMySquadJoinStatus}
                    setBadgeRequestsInbox={setBadgeRequestsInbox}
                    setBadgeRequestsBusy={setBadgeRequestsBusy}
                    setBadgeRequestsError={setBadgeRequestsError}
                  />
