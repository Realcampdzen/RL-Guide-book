...
export function useCabinetForms() {
  ...
  return {
    ...
    devPinInput, setDevPinInput,
    customAvatarUrl, setCustomAvatarUrl,
    squadInviteCode, setSquadInviteCode,
    joinSquadLoading, setJoinSquadLoading,
    joinSquadError, setJoinSquadError,
  };
}
