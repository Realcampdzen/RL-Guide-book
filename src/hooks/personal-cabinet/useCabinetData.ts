...
export function useCabinetData() {
  ...
  return {
    badgesConfig, setBadgesConfig,
    badgesLoading, setBadgesLoading,
    aiDataLoading, setAiDataLoading,
    mySquadInfoApi, setMySquadInfoApi,
    vozhatifikatorHtml, setVozhatifikatorHtml,
    vozhatifikatorToc, setVozhatifikatorToc,
    vozhatifikatorLoading, setVozhatifikatorLoading,
    vozhatifikatorError, setVozhatifikatorError,
  };
}
