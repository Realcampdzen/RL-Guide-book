...
# -*- coding: utf-8 -*-
"""
Ультимативный парсер - находит все данные в Путеводителе
"""
...
def extract_badge_info_from_guide(badge_id):
    ...
    # Ищем строку с "Цель:" после основного значка
...
def main():
    ...
    print("📖 Находим все данные в Путеводителе")
    ...
    result = {
        ...
        "generated_by": "ultimate_parser.py",
        "source": "Путеводитель.txt"
    }
    
    # Сохраняем результат
    output_file = "perfect_parsed_data_ultimate.json"
