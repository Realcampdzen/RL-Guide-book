...
// Fix title text
s = s.replace(
  /<div className="chat-button-title">[\s\S]*?<\/div>/,
  '<div className="chat-button-title">\n          Чат-бот\n        </div>'
);

// Fix subtitle text
s = s.replace(
  /<div className="chat-button-subtitle">[\s\S]*?<\/div>/,
  '<div className="chat-button-subtitle">\n          Всегда рядом\n        </div>'
);
