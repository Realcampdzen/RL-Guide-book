            ...
            {posts.map((post, idx) => (
              ...
              >
                <div className="post-img-box">
                  <img src={`${baseUrl}pictures/${post.img}`} alt={post.title} />
                </div>
          ...
          >
            <div style={{ flex: '1 1 400px' }}>
              ...
              <p className="card-text" style={{ fontSize: '1.3rem' }}>
                ...
                смены. Реальные истории и эмоции в нашей группе ВКонтакте.
              </p>
            </div>
            <a
          ...
          <div className="session-card-glow hover-target" onClick={onTelegramContact}>
            ...
            >
              <p style={{ marginBottom: '1rem', fontSize: '1.3rem', color: 'var(--c-stark)' }}>
                ✅ <strong style={{ color: '#FFD700' }}>25 800</strong> — стоимость путевки с учетом
                сертификата от г. Санкт-Петербурга на 9 дней
                <br />
              ...
              <p style={{ fontSize: '1.3rem', color: 'var(--c-stark)' }}>
                ✅ <strong>36 500,00 руб.</strong> — полная стоимость путевки на 9 дней без
