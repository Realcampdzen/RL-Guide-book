import { __commonJS, require_react } from './chunk-GIQZIPNC.js';
    ...
    if (true) {
      (() => {
        ...
        function postMountWrapper(element, props, isHydrating2) {
          var node = element;
          if (Object.hasOwn(props, 'value') || Object.hasOwn(props, 'defaultValue')) {
            var type = props.type;
        ...
        function updateOptions(node, multiple, propValue, setDefaultSelected) {
          ...
          if (multiple) {
            ...
            for (var _i = 0; _i < options2.length; _i++) {
              var selected = Object.hasOwn(selectedValue, '$' + options2[_i].value);
        ...
        var camelize = (string) =>
          string.replace(hyphenPattern, (_, character) => character.toUpperCase());
        var warnHyphenatedStyleName = (name) => {
          if (Object.hasOwn(warnedStyleNames, name) && warnedStyleNames[name]) {
            return;
          }
        ...
        var warnStyleValueWithSemicolon = (name, value) => {
          if (Object.hasOwn(warnedStyleValues, value) && warnedStyleValues[value]) {
            return;
          }
        ...
        function validateProperty(tagName, name) {
          ...
          if (rARIACamel.test(name)) {
            ...
            var correctName = Object.hasOwn(ariaProperties, ariaName) ? ariaName : null;
            if (correctName == null) {
              error(
          ...
          if (rARIA.test(name)) {
            ...
            var standardName = Object.hasOwn(ariaProperties, lowerCasedName)
              ? lowerCasedName
              : null;
        ...
        function warnInvalidARIAProps(type, props) {
          ...
          var unknownPropString = invalidProps.map((prop) => '`' + prop + '`').join(', ');
        ...
        validateProperty$1 = (tagName, name, value, eventRegistry) => {
          ...
          if (eventRegistry != null) {
            ...
            if (Object.hasOwn(registrationNameDependencies2, name)) {
              return true;
            }
            var registrationName = Object.hasOwn(possibleRegistrationNames2, lowerCasedName)
        ...
        if (
          ...
          invokeGuardedCallbackImpl = function invokeGuardedCallbackDev(
            ...
            function restoreAfterDispatch() {
              ...
              if (typeof window.event !== 'undefined' && Object.hasOwn(window, 'event')) {
        ...
        function retryIfBlockedOn(unblocked) {
          ...
          var unblock = (queuedEvent2) => scheduleCallbackIfUnblocked(queuedEvent2, unblocked);
        ...
        function createSyntheticEvent(Interface) {
          function SyntheticBaseEvent(
            ...
            for (var _propName in Interface) {
              if (!Object.hasOwn(Interface, _propName)) {
                continue;
              }
        ...
        function dispatchEventForPluginEventSystem(
          ...
          batchedUpdates(() =>
            dispatchEventsForPlugins(domEventName, eventSystemFlags, nativeEvent, ancestorInst)
          );
        }
        ...
        function setInitialDOMProperties(
          ...
          for (var propKey in nextProps) {
            if (!Object.hasOwn(nextProps, propKey)) {
              continue;
            }
            ...
            else if (Object.hasOwn(registrationNameDependencies, propKey)) {
              if (nextProp != null) {
              ...
              if (lastProp) {
                for (styleName in lastProp) {
                  if (
                    ...
                    (!nextProp || !Object.hasOwn(nextProp, styleName))
                  ) {
                    if (!styleUpdates) {
                      styleUpdates = {};
                    }
        ...
        function diffHydratedProperties(
          ...
          for (var propKey in rawProps) {
            if (!Object.hasOwn(rawProps, propKey)) {
              continue;
            }
        ...
        function unhideInstance(instance, props) {
          ...
          var display =
            styleProp !== void 0 && styleProp !== null && Object.hasOwn(styleProp, 'display')
              ? styleProp.display
              : null;
        ...
        function ChildReconciler(shouldTrackSideEffects) {
          ...
          function reconcileChildrenArray(returnFiber, currentFirstChild, newChildren, lanes) {
            ...
            if (shouldTrackSideEffects) {
              existingChildren.forEach((child2) => deleteChild(returnFiber, child2));
            }
            if (getIsHydrating()) {
        ...
        appendAllChildren = (parent, workInProgress2, needsVisibilityToggle, isHidden) => {
        ...
        var shouldErrorImpl = (fiber) => null;
        ...
        var copyWithSet = (obj, path, value) => copyWithSetImpl(obj, path, 0, value);
